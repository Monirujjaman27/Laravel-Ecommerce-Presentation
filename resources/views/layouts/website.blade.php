...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/web') }}/css/blue.css">
    <link rel="stylesheet" href="{{asset('assets/web') }}/css/owl.carousel.css">
    <link rel="stylesheet" href="{{asset('assets/web') }}/css/owl.transitions.css">
    <link rel="stylesheet" href="{{asset('assets/web') }}/css/animate.min.css">
    <link rel="stylesheet" href="{{asset('assets/web') }}/css/rateit.css">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-10 logo-holder">
                        <div class="logo">
                            <a href="home.html"> <img src="{{asset('assets/web') }}/images/logo.png" alt="logo"> </a>
                        </div>
                    </div>
                                ...
                                <li>
                                    <div class="cart-item product-summary">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image">
                                                    <a href="detail.html"><img src="{{asset('assets/web') }}/images/cart.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-xs-7">
                                                    ...
                                                    <div class="yamm-content">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                                <a href="#"><img alt="" src="{{asset('assets/web') }}/images/banners/banner-side.png"></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </ul>
...
@yield('content')
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 no-padding">
                    <div class="clearfix payment-methods">
                        <ul>
                            <li><img src="{{asset('assets/web') }}/images/payments/1.png" alt=""></li>
                            <li><img src="{{asset('assets/web') }}/images/payments/2.png" alt=""></li>
                            <li><img src="{{asset('assets/web') }}/images/payments/3.png" alt=""></li>
                            <li><img src="{{asset('assets/web') }}/images/payments/4.png" alt=""></li>
                            <li><img src="{{asset('assets/web') }}/images/payments/5.png" alt=""></li>
                        </ul>
                    </div>
                    <!-- /.payment-methods -->
                </div>
    ...
    <script src="{{asset('assets/web') }}/js/jquery-1.11.1.min.js"></script>
    <script src="{{asset('assets/web') }}/js/bootstrap.min.js"></script>
    <script src="{{asset('assets/web') }}/js/bootstrap-hover-dropdown.min.js"></script>
    <script src="{{asset('assets/web') }}/js/owl.carousel.min.js"></script>
    <script src="{{asset('assets/web') }}/js/echo.min.js"></script>
    <script src="{{asset('assets/web') }}/js/jquery.easing-1.3.min.js"></script>
    <script src="{{asset('assets/web') }}/js/bootstrap-slider.min.js"></script>
    <script src="{{asset('assets/web') }}/js/jquery.rateit.min.js"></script>
    <script type="text/javascript" src="{{asset('assets/web') }}/js/lightbox.min.js"></script>
